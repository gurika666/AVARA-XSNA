// gui.js - Handles all UI/GUI elements
...
export function setupUI(startCallback, pauseCallback, scrubInputCallback, scrubChangeCallback) {
  ...
  scrubber.addEventListener('input', scrubInputCallback);
  scrubber.addEventListener('change', scrubChangeCallback);
